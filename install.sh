...
echo 'echo -e "██      ██   ██ ██  ██  ██ ██ ██      ██    "' >> .bashrc
echo 'echo -e "██      ██   ██ ██      ██ ██ ███████ ██    "' >> .bashrc
echo 'echo -e "                 The Big Kadall Family Group™" | lolcat' >> .bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/janda09/kadal/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by JandaBaper</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/janda09/kadal/master/vps.conf"
...
# server settings
cd /etc/openvpn/
wget -O /etc/openvpn/server.conf "https://raw.githubusercontent.com/janda09/kadal/master/server.conf"
...
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/janda09/kadal/master/iptables"
...
# openvpn config
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/janda09/kadal/master/client.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
echo '<ca>' >> /etc/openvpn/client.ovpn
cat /etc/openvpn/ca.crt >> /etc/openvpn/client.ovpn
echo '</ca>' >> /etc/openvpn/client.ovpn
cp client.ovpn /home/vps/public_html/
wget -O /etc/openvpn/openvpnssl.ovpn "https://raw.githubusercontent.com/janda09/kadal/master/openvpnssl.conf"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "hhttps://raw.githubusercontent.com/janda09/kadal/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/janda09/kadal/master/badvpn-udpgw64"
fi
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/janda09/kadal/master/squid3.conf"
...
cd /etc/stunnel/
wget -O /etc/stunnel/ssl.conf "https://raw.githubusercontent.com/janda09/kadal/master/ssl.conf"
...
wget https://raw.githubusercontent.com/janda09/kadal/master/ddos-deflate-master.zip
...
# banner /etc/bnr
wget -O /etc/bnr "https://raw.githubusercontent.com/janda09/kadal/master/bnr"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/janda09/kadal/master/menu.sh"
wget -O edit "https://raw.githubusercontent.com/janda09/kadal/master/edit-ports.sh"
wget -O edit-dropbear "https://raw.githubusercontent.com/janda09/kadal/master/edit-dropbear.sh"
wget -O edit-openssh "https://raw.githubusercontent.com/janda09/kadal/master/edit-openssh.sh"
wget -O edit-openvpn "https://raw.githubusercontent.com/janda09/kadal/master/edit-openvpn.sh"
wget -O edit-squid3 "https://raw.githubusercontent.com/janda09/kadal/master/edit-squid3.sh"
wget -O edit-stunnel4 "https://raw.githubusercontent.com/janda09/kadal/master/edit-stunnel4.sh"
wget -O show-ports "https://raw.githubusercontent.com/janda09/kadal/master/show-ports.sh"
wget -O usernew "https://raw.githubusercontent.com/janda09/kadal/master/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/janda09/kadal/master/trial.sh"
wget -O delete "https://raw.githubusercontent.com/janda09/kadal/master/delete.sh"
wget -O check "https://raw.githubusercontent.com/janda09/kadal/master/user-login.sh"
wget -O member "https://raw.githubusercontent.com/janda09/kadal/master/user-list.sh"
wget -O restart "https://raw.githubusercontent.com/janda09/kadal/master/restart.sh"
wget -O speedtest "https://raw.githubusercontent.com/janda09/kadal/master/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/janda09/kadal/master/info.sh"
wget -O about "https://raw.githubusercontent.com/janda09/kadal/master/about.sh"
...
echo "Dropbear : 443, 990"  | tee -a log-install.txt
